...
$CantidadEmpleado = count($listadoEmpleado);
  ...
  if (!empty($_GET['ID'])){
      $datosObtenidos=Listar_EmbargodeEmpleado($conexion, $_GET['ID']);
  }else{
            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="post"> <!--se agrego el metodo post para la captura de datos -->
                ...
                <div class="col-6">
                  ...
                  <input type="number" step="0.1"   class="form-control" id="monto" name="monto" value='<?php echo $datosObtenidos['MONTO'];?>'>
                </div>

                <div class="col-6">
                  <label for="descripcion" class="form-label">Descripción(*)</label>
                  <input type="text"  class="form-control" id="descripcion" name="descripcion" value='<?php echo $datosObtenidos['DESCRIPCION'];?>'>
                </div>
