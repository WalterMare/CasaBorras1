...
<body>
    ...
    <main id="main" class="main ">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Gestión de Viáticos</h5>

                <!-- Nav Tabs -->
                <ul class="nav nav-tabs" id="viaticoTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="registrar-tab" data-bs-toggle="tab" data-bs-target="#registrar" type="button" role="tab">Registrar Viático</button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content pt-2" id="viaticoTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="registrar" role="tabpanel">
                        <?php include 'Registrar_viatico.php'; ?>
                    </div>

                    <!-- Tab de Historial -->
                    <div class="tab-pane fade" id="consultar" role="tabpanel">
                        <?php include 'Listado_Viatico_Empleado.php'; ?>
                    </div>
                </div>
