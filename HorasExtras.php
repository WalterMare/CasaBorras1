            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="viaticoTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="registrar-tab" data-bs-toggle="tab" data-bs-target="#registrar" type="button" role="tab">Registrar Hora Extra</button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content pt-2" id="viaticoTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="registrar" role="tabpanel">
                        <?php include 'RegistrarHoraExtra.php'; ?>
                    </div>

                    <!-- Tab de Historial -->
                    <div class="tab-pane fade" id="consultar" role="tabpanel">
                        <?php include 'Listado_HorasExtra_Empleado.php'; ?>
                    </div>
                </div>
