...
<head>
    ...
    <title>Consulta de Embargos Judiciales asociados a un empleado</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Embargo Judicial asociado a un Empleado</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Gestor de movimientos</li>
                    <li class="breadcrumb-item active">Consultar Embargo Judicial de un Empleado</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (!empty($_POST['BotonBuscar'])) {
                                ...
                                if (empty($Mensaje)) {
                                    if (Listar_EmbargoEmpleado($MiConexion, $_POST['empleado']) != false) {
                                        $listado = Listar_EmbargoEmpleado($MiConexion, $_POST['empleado']);
                                    ...
                                    <div id='cartel' class="alert alert-<?php echo $Estilo; ?> alert-dismissible fade show" role="alert">
                                        ...
                                        <?php if ($Mensaje == '') {
                                            $Mensaje = 'No tiene Embargos Judiciales asociados';
                                            echo $Mensaje;
                                        } else {
                                            echo $Mensaje;
                                        } ?>
                            ...
                            <?php if ($Cantidad != 0 && $Cantidad != null) { ?>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h5 class="card-title">Embargo Judiciales</h5>
                                                <!-- Default Table -->
