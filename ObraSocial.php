...
<body>
    ...
    <main id="main" class="main ">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Obra Social</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Gestión de Obra Social</h5>

                <!-- Nav Tabs -->
                <ul class="nav nav-tabs" id="ObrasocialTabs" role="tablist">
                ...
                <div class="tab-content pt-2" id="ObrasocialTabsContent">
                    <!-- Tab de Registro -->
                    <div class="tab-pane fade show active" id="registrar" role="tabpanel">
                        <?php include 'Registrar_Obrasocial.php'; ?>
                    </div>

                    <!-- Tab de Historial -->
                    <div class="tab-pane fade" id="consultar" role="tabpanel">
                        <?php include 'Listado_Obrasocial_Empleado.php'; ?>
                    </div>
                </div>
