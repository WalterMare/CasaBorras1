                                ...
                                if ($tipo_reporte == '1') { ?>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <?php } else { ?>
                                            <tbody>
                                                <tr>
                                                    <td colspan="6" class="text-center">No hay licencias disponibles para este empleado.</td>
                                                </tr>
                                            </tbody>
                                        <?php } ?>
                                    </table>
                                <?php } ?> <!-- End Default Table Example -->
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Default Table -->
                                    <?php
                                    // Verificar y sanitizar el idLicencia
                                    if ($idLicencia != 0) {
                                        $listadoDetalle = Listar_Reporte_Empleado3_Detalle($conexion, $idLicencia);
                                        $CantidadDetalle = count($listadoDetalle);
                                    } else {
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <?php if ($CantidadDetalle != 0 && $CantidadDetalle  != null) { ?>
                                            <tbody>
                                                <?php for ($i = 0; $i < $CantidadDetalle; $i++) { ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $i + 1; ?></th>
                                                        <td><?php echo $listadoDetalle[$i]['DESCRIPCION']; ?></td>
                                                        <td><?php echo $listadoDetalle[$i]['FECHACREACION']; ?></td>
                                                        <td><?php echo $listadoDetalle[$i]['NOMBRE'] . " " . $listadoDetalle[$i]['APELLIDO']; ?></td>
                                                        <td><?php echo $listadoDetalle[$i]['DOCUMENTACION']; ?></td>
