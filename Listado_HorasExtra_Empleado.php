...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Lista de Horas Extras de un Empleado</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Gestor de movimientos</li>
                    <li class="breadcrumb-item active">Consultar Horas Extras de un Empleado</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (!empty($_POST['BotonBuscar'])) {
                                ...
                                if (empty($Mensaje)) {
                                    if (Listar_horaExtraEmpleado($MiConexion, $_POST['empleado']) != false) {
                                        $listadoExtra = Listar_horaExtraEmpleado($MiConexion, $_POST['empleado']);
                                        $CantidadExtra = count($listadoExtra);
                                    ...
                                    <div class="alert alert-<?php echo $Estilo; ?> alert-dismissible fade show" role="alert">
                                        ...
                                        <?php if ($Mensaje == '') {
                                            $Mensaje = 'No posee Horas Extras registradas';
                                            echo $Mensaje;
                                        } else {
                                            echo $Mensaje;
                                        } ?>
                            ...
                            <?php if ($CantidadExtra != 0 && $CantidadExtra != null) { ?>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h5 class="card-title">Horas Extras del empleado</h5>
                                                <!-- Default Table -->
