...
require_once 'select_Viatico.php';
...
<head>
    ...
    <title>Listado de Viaticos de un empleado</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Lista de viaticos de un Empleado</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Gestor de movimientos</li>
                    <li class="breadcrumb-item active">Consultar Viatico de Empleado</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (!empty($_POST['BotonBuscar'])) {
                                ...
                                if (empty($Mensaje)) {
                                    if (Listar_viaticoEmpleado($MiConexion, $_POST['empleado']) != false) {
                                        $listadoViatico = Listar_viaticoEmpleado($MiConexion, $_POST['empleado']);
                                    ...
                                    <div class="alert alert-<?php echo $Estilo;?> alert-dismissible fade show" role="alert">
                                        ...
                                        <?php  if ($Mensaje==''){ $Mensaje='No posee Viaticos registrados'; echo $Mensaje;} else{
                                            echo $Mensaje;
                                        } ?>
                                    </div>
                                    <?php }} ?>
                            ...
                            <?php if ($CantidadViatico != 0 && $CantidadViatico != null) { ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">Viaticos del empleado</h5>
                                            <!-- Default Table -->
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <?php if ($CantidadViatico != 0 && $CantidadViatico != null) { ?>
                                                    <tbody>
                                                        <?php for ($i = 0; $i < $CantidadViatico; $i++) { ?>
                                                            <tr>
                                                                <th scope="row"><?php echo $i + 1; ?></th>
                                                                <td><?php echo $listadoViatico[$i]['NOMBRE']." ".$listadoViatico[$i]['APELLIDO']; ?></td>
                                                                <td><?php echo $listadoViatico[$i]['DESCRIPCION']; ?></td>
                                                                <td><?php echo $listadoViatico[$i]['FECHA']; ?></td>
                                                                <td><?php echo $listadoViatico[$i]['MONTO']; ?></td>
                                                            </tr>
                                                        <?php }; ?>
                                                    </tbody>
                                                <?php }?>
