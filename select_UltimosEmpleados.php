...
function Listar_ultimosEmpleados($vConexion,$tiempo, $estado) {
    ...
    $consulta = "SELECT E.nombre, E.apellido, E.fecha_inicio, E.estado, C.descripcion FROM empleado AS E, cargo AS C WHERE E.fecha_inicio>= DATE_SUB(CURDATE(), INTERVAL $tiempo YEAR)  AND E.estado=$estado AND E.Idcargo=C.idcargo ORDER BY E.fecha_inicio ";
