...
$CantidadEmpleado = count($listadoEmpleado);
  ...
  if (!empty($_GET['ID'])){
      $datosObtenidos=Listar_ObraSocialdeEmpleado($conexion, $_GET['ID']);
  }else{
      $_SESSION['Mensaje']= 'Sin datos para mostrar...';
  }

require_once 'validacion_registro_ObraSocial.php';
require_once 'Modificar_datos_ObraSocial.php';
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Modificar Obra Social</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              if (!empty($_POST['BotonRegistrar'])) {
                ...
                if (empty($Mensaje)) {
                  if (ModificarObra($conexion,$_GET['ID']) != false) {
              ...
              <form class="row g-3" method="post"> <!--se agrego el metodo post para la captura de datos -->
                ...
                <div class="col-6">
                  <label for="nombre" class="form-label">Obra Social</label>
                  <input type="text" class="form-control" id="nombre" name="nombre" VALUE="<?php echo $datosObtenidos['DESCRIPCION'];?>">
                </div>
