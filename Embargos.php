...
<body>
    ...
    <main id="main" class="main ">
        ...
        <div class="pagetitle">
            <h1>Embargos Judiciales</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Gestor de movimientos</li>
                    <li class="breadcrumb-item active">Embargos</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Gestión de Embargos Judiciales</h5>

                <!-- Nav Tabs -->
                <ul class="nav nav-tabs" id="EmbargosTabs" role="tablist">
                ...
                <div class="tab-content pt-2" id="EmbargosTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="registrar" role="tabpanel">
                        <?php include 'Registrar_Embargo.php'; ?>
                    </div>

                    <!-- Tab de Historial -->
                    <div class="tab-pane fade" id="consultar" role="tabpanel">
                        <?php include 'Listado_Embargo_Empleado.php'; ?>
                    </div>
                </div>
