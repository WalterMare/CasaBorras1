...
$Cantidadsanciones = count($listadosanciones);
...
require_once 'validacion_registro_sanciones.php';
require_once 'insertar_sanciones.php';
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Registrar Sanciones</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Gestor de movimientos</li>
          <li class="breadcrumb-item active">Registrar Sanciones</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              if (!empty($_POST['BotonRegistrar'])) {
                ...
                if (empty($Mensaje)) {
                  if (InsertarSancion($conexion) != false) {
              ...
              <form class="row g-3" method="post"> <!--se agrego el metodo post para la captura de datos -->
                ...
                <div class="col-6">
                  ...
                  <select class="form-select" aria-label="Selector" id="selector" name="tipo"> <!--combobox ya cargado con las marcas traidas desde la bd -->
                    ...
                    <?php
                    $selected = '';
                    for ($i = 0; $i < $Cantidadsanciones; $i++) {
                      if (!empty($_POST['tipo']) && $_POST['tipo'] ==  $listadosanciones[$i]['ID']) { //recuerda el elemento seleccionado
                        $selected = 'selected';
                      } else {
